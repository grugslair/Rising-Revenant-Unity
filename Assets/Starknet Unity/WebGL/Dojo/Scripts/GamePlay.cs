...
public class GamePlay : MonoBehaviour
{
    ...
    {
        string contractAddress = "0x54017a9219f6483af430c0aa45dd5d6d1fa129d768b01d427636a5121b5f285";

        var arr = new string[2] { "210" , "20"};

        string calldataString = JsonUtility.ToJson(new ArrayWrapper { array = arr });
        JSInteropManager.SendTransactionArgentX(contractAddress, "create", calldataString, gameObjectName, "Callback");
    }
